...
public enum ApplicationErrorCode {
    ...
    INTERCEPTOR_ERROR("There was an intercepted error on the server and the request could not be completed."),
    SERVICE_NOT_IMPLEMENTED("The requested service is not implemented in this api version."),
    MONITOR_ERROR("Unknown error monitoring the application."),
    COMMUNICATION_ERROR("The server is unavailable to handle this request right now. Please try again later."),
